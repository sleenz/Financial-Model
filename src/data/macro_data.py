...
DEFAULT_MACRO_VARIABLES: list[MacroVariableConfig] = [
    ...
    MacroVariableConfig(
        name="CHINA_PMI",
        primary_ticker="CHNFACMIDXM",
        primary_source="fred",
        fallback_ticker=None,
        fallback_source=None,
        transform="level",
        frequency="M",
        description="China NBS Manufacturing PMI — commodity demand proxy",
    ),
    MacroVariableConfig(
        name="CPO",
        primary_ticker="FCPO.BMD",
        primary_source="yfinance",
        fallback_ticker="KO=F",
        fallback_source="yfinance",
        transform="pct_change",
        frequency="W",
        description="Crude Palm Oil futures — IDX #1 agricultural export",
    ),
    MacroVariableConfig(
        name="COAL",
    ...
    MacroVariableConfig(
        ...
        transform="pct_change",
        frequency="W",
        description="Nickel futures — ANTM, INCO; EV battery demand proxy",
    ),
]
